function glossarize(markup) {
	...
	"Jussive mood","Kinship affix","Limitative","Masculine gender","Middle voice; medio-passive","Mitigation","Momentane (single-event verb)","Narrative tense","Necessitative","Non-finite","Non-human","Nominalizer; nominalization","Numeral; numerative","Nonvisual experiential (evidential)","Object(ive)","Obligative mood","Obviative","Object focus","Onomatopoeia","Ordinal numeral","Passive voice","Paucal number","Pausal","Pegative case (a special case for the giver)","Perfective aspect","Perlative case","Patient focus; patient voice","Perfective aspect","Pluperfect","Pluractional","Polite register","Possible; modal possibility","Past perfective","Polar question particle","Precative mood (requests)","Predicative affix; predicative","Preposition; prepositional case","Perfect","Progressive aspect","Prohibitive mood (do not!)","Proprietive case","Past tense","Participle","Partitive case","Purposive case","Preverb","Quotative","Reciprocal voice","Reduplication","Reduplication","Referential","Reflexive (reflexive pronoun; reflexive voice)","Relative clause marker","Remote","Repetitive aspect","Resultative","Respect","Reported evidential","Rhetorical question",

function glossarize(markup) {
	...
	"IAM","IC","ICOM","IDEO","IDEOPH","IDPH","IF","IFUT","IGNOR","ILL","ILLA","IMMED","IMP","IMPER","IMPF","IMPOSS","IMPR","IN","INAB","INABL","INACT","INAL","INANIM","INC","INCEP","INCH","INCHO","INCL","IND","INDET","INDF","INDEF","INDIC","INDIR","INEL","INESS","INF","INFER","INFL","INFR","ING","INS","INTENS","INTENTV","INTER","INTERESS","INTERJ","INTERP","INTJ","INTL","INTR","INTRV","INTS","INTV","INV","INVOL","IO","IOBJ","IP","IPFV","IRR","ITER","JUS","LIM","MASC","MID","MIT","MOM","NARR","NEC","NFIN","NH","NMLZ","NUM","NVEXP","O","OBLIG","OBJ","OBV","OFC","ONOM","ORD","PASS","PAU","PAUS","PEG","PERFV","PERL","PF","PFV","PLUP","PLUR","POL","POSB","PPFV","PQP","PREC","PRED","PREP","PRF","PROG","PROH","PROP","PST","PTCP","PTV","PURP","PVB",
	"QUOT","RECP","RED","REDUP","REF","REFL","REL","REM","REP","RES","RESP","RPRT","RQ","S","SBJ","SCEP","SEM","SENS","SIM","SJV","SPECL","STAT","SUB","SUBL","SUG","SUPEL","SUPL","TENT","TOP","TRI","UF","UH","UNCERT","UR","UWPST","VAL","VBLZR","VEG","VEN","VENT","VERT","VIA","VN","VOC","VOL","WH","WHQ","WIT","WP","WPST","YNQ","DTRNZ","ER","EXH","HSY","MAL","PDS","POS1","POS2","POS3","POS1p","POS2p","POS3p","FRUSTR","FDS ","FSSI","FSST","PSSI","PSST","SDS","SSSI","SSST","AB"];

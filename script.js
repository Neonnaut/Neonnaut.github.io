function glossarize(markup) {
	...
	var origExplanations = ["First person (speaker)", "Second person (listener)", "Third person (referent)", "Fourth person (oviative or generic)", "First person inclusive", "Accusative case", "Animate gender", "Animate gender", "Classifier", "Dative case", "Ergative case", "Feminine gender", "Future", "Genitive case", "Human gender; anthropic gender", "Inanimate gender", "Instrumental case", "Instrumental case", "Locative case", "Masculine gender", "Neuter gender", "Negation; negative", "Neuter", "Nominative case", "Oblique case", "Past", "Plural", "Possessive; possessor", "Present tense", "Question word or particle", "Rational gender (thinking beings)", "Singular", "Zero (null) morpheme", "First person inclusive dual", "First person inclusive plural", "First person inclusive paucal", "First person inclusive singular", "First person inclusive trial", "First person dual (you two)", "First person exclusive", "First person exclusive dual", "First person exclusive plural", "First person exclusive paucal", "First person inclusive singular", "First person genitive (my or our)", "First person plural (we)", "First person paucal", "First person singular (I; me)", "First person trial", "Second person dual", "Second person genitive (your)", "Second person plural", "Second person paucal", "Second person singular (you)", "Second person trial", "Third person dual", "Third person genitive (their)", "Third person plural (they)", "Third person paucal", "Third person singular (they)", "Third person singular feminine (she)", "Third person singular masculine (he)", "Third person trial",
		...
		"Iamitive", "Involuntary causative", "Involuntary comitative", "Ideophone", "Ideophone", "Ideophone", "Instrument focus", "Indefinite future", "Ignorative", "Illative case (into)", "Illative case (into)", "Immediate past", "Imperative mood", "Imperative mood", "Imperfect", "Modal impossibility", "Imprecative mood", "Inclusive person", "Impotential", "Inablative", "Inactive", "Inalienable possession", "Inanimate gender", "Inclusive person", "Inceptive aspect", "Inchoative aspect", "Inchoative aspect", "Inclusive", "Indicative", "Indeterminate", "Indefinite", "Indefinite human (somebody)", "Indicative mood", "Indirect; indirective", "Inelative case (from within)", "Inessive case (in)", "Infinitive", "Inferential mood", "Inflectional", "Inferential mood", "Ingressive case", "Instrumental", "Intensifier; intensive", "Intentive", "Interrogative", "Interessive", "Interjection", "Interpellative mood", "Interjection", "Intentional", "Intransitive", "Introversive", "Intensifier; intensive", "Intentive", "Inverse", "Involuntative; involitive", "Indirect object (ive)", "Indirect object", "Immediate past", "Imperfective", "Irrealis", "Iterative aspect", "Jussive mood", "Limitative", "Masculine gender", "Middle voice; medio-passive", "Mitigation", "Momentane (single-event verb)", "Narrative tense", "Necessitative", "Non-finite", "Non-human", "Nominalizer; nominalization", "Numeral; numerative", "Nonvisual experiential (evidential)", "Object(ive)", "Obligative mood", "Obviative", "Object focus", "Onomatopoeia", "Ordinal numeral",
		"Passive voice", "Paucal number", "Pausal", "Pegative case (a special case for the giver)", "Perfective aspect", "Perlative case", "Patient focus; patient voice", "Perfective aspect", "Pluperfect", "Pluractional", "Polite register", "Possible; modal possibility", "Past perfective (= perfect)", "Polar question particle", "Precative mood (requests)", "Predicative affix; predicative", "Preposition; prepositional case", "Perfect", "Progressive aspect", "Prohibitive mood (do not!)", "Proprietive case", "Past tense", "Participle", "Partitive case", "Purposive case", "Preverb", "Quotative", "Reciprocal voice", "Reduplication", "Reduplication", "Referential", "Reflexive ( reflexive pronoun; reflexive voice )", "Relative clause marker", "Remote", "Repetitive aspect", "Reported evidential", "Rhetorical question", "Single argument of canonical intransitive verb", "Subject; subject agreement", "Sceptical", "Semelfactive aspect (once)", "Sensory evidential mood", "Simultaneous aspect; simultaneity", "Subjunctive mood", "Stative aspect", "Sublocative (under)", "Sublative case (onto; down onto)", "Suggestive mood", "Superelative case (on)", "Superlative", "Topic marker", "Trial number", "Uncertain future", "Uphill; inland", "Uncertain mood", "Upriver", "Unwitnessed past", "Valency increasing; valence marker", "Verbalizer", "Vegetable (food) gender", "Venitive (coming towards; andative)", "Ventive; ventitive", "Vertical", "Vialis case", "Vocative case", "Volitive mood; volitional", "Interrogative pronoun", "Wh- question", "Witnessed evidential", "Witnessed past", "Witnessed past", "Yes–no question"];
	var abbreviations = [];
	var explanations = [];
